 ...
 */
const VERSION = "today-v2-foundation-045";
...
const APP_SHELL = [
  ...
  "./assets/sport/leg-raise.jpg",
  "./assets/sport/mountain-climber.jpg",
  "./assets/sport/one-arm-row.jpg",
  "./assets/sport/overhead-triceps.jpg",
  "./assets/sport/pec-deck-fly.jpg",
